    ...
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
          ...
          <>
            ...
            <section className="flex flex-col md:flex-row items-center mb-16">
              <div className="md:w-1/2 p-4">
                ...
                <p className="text-lg mb-4">
                  Our app simplifies event planning from start to finish. Easily
                  create and customize events, manage RSVPs with tailored
                  registration forms, and track your schedule with our
                  interactive calendar. Real-time updates and integrated
                  communication tools ensure you stay connected with attendees,
                  while comprehensive reporting and analytics help you measure
                  success. With a user-friendly interface and responsive design,
                  our app makes managing your events effortless and efficient.
                </p>
              </div>
              <div className="md:w-1/2 p-4">
                <img
            ...
            <section className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 p-4">
                ...
                <p className="text-lg mb-4">
                  Our app offers a complete solution for event management.
                  Easily track RSVPs, send invitations, and handle all aspects
                  of your event from a single platform. Enjoy seamless
                  organization, real-time updates, and comprehensive reporting
      ...
      <footer className="bg-pink-900 text-white p-6 flex flex-col md:flex-row md:justify-between items-center rounded-t-lg">
        ...
        <div className="flex flex-row items-center md:items-start space-y-4 md:space-y-0 md:flex-row md:space-x-8">
          ...
          <div className="text-xl flex flex-row items-center justify-center font-bold">
            Event Planner
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:space-x-12 space-y-4 md:space-y-0 mt-4 md:mt-0">
          <div className="flex flex-col space-y-2">
            ...
            <a
              href="mailto:buragaravi2002@gmail.com"
              className="hover:text-pink-300 transition duration-300"
            >
              Email: example@gmail.com
            </a>
            <a
              href="tel:+919010462357"
              className="hover:text-pink-300 transition duration-300"
            >
              Phone: +91 9087686235
            </a>
