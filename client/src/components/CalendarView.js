...
const CalendarView = () => {
    ...
    return (
      <div class="relative h-screen w-screen bg-gray-800 flex flex-col  align-center justify-center items-center">
        ...
        <div className=" mt-12 text-pink-400 flex justify-center align-center text-2xl  font-bold">
          <p>Loading Your Events in CalendarView ....... </p>
        </div>{" "}
      </div>
    );
  if (error)
    return (
      <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6">
        <div className="w-full text-pink-400 flex justify-center align-center  font-bold max-w-lg p-6 bg-gray-800 rounded-lg shadow-lg">
          {error}
        </div>
      </div>
    );
  ...
  if (events.length === 0)
    return <p className="text-pink-300">No events found.</p>;
  ...
  const upcomingEvents = Object.entries(groupedEvents)
            ...
            <div className="events-group">
              ...
              <ul className="space-y-2">
                {upcomingEvents.map(([date, events]) => (
                  <div key={date}>
                    <h4 className="text-lg font-semibold text-pink-300 mb-1">
