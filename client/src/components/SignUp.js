...
const SignUp = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      ...
      >
        <h2 className="text-2xl  font-bold text-center mb-6 text-pink-300">
          Sign Up
        </h2>
        <div className="mb-4">
          <label
        ...
        <button
          type="submit"
          className="w-full py-2 px-4 bg-pink-500 text-pink-500 rounded-md hover:bg-pink-600 transition duration-300"
        >
          Sign Up
        </button>
